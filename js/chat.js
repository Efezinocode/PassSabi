...
// How many prior chat turns (user + assistant messages combined) to send
// back to the model as context. Keeps the request payload bounded while
// still giving the model real short-term memory of the conversation.
...
// Builds the actual message history sent to the model: every prior
// user/assistant turn in the current session (most recent
// MAX_HISTORY_MESSAGES), in order. This is what gives the AI real
// conversational memory instead of only ever seeing the latest message.
